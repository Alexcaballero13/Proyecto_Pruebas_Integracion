...
public class RegistryControllerIT {
    ...
    static class TestBeans {
        ...
        public RegistryRepositoryPort registryRepositoryPort() throws Exception {
            RegistryRepository repo = new RegistryRepository("jdbc:h2:mem:systemdb;DB_CLOSE_DELAY=-1");
            repo.initSchema();
            return repo;
        }
    ...
    public void shouldReturnValidWhenPostRequest() {
        String json = "{\"name\":\"Ana\",\"id\":200,\"age\":30,\"gender\":\"FEMALE\",\"alive\":true}";
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        ResponseEntity<String> resp = rest.postForEntity("/register",
    ...
    @Test
    public void shouldReturnDuplicatedOnSecondPost() {
        String json = "{\"name\":\"Ana\",\"id\":201,\"age\":30,\"gender\":\"FEMALE\",\"alive\":true}";
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
